...
extension ProfileEntity {
    ...
    @NSManaged private var books: NSSet?

    @nonobjc
    public var profile_books: [BookCSVData] {
        guard let books = books as? Set<BookCSVData> else {
            print("No books from relationship")
            return []
        }
        return Array(books)
    }
...
extension ProfileEntity {
    ...
    @objc(addBooksObject:)
    @NSManaged public func addToBooks(_ value: BookCSVData)

    @objc(removeBooksObject:)
    @NSManaged public func removeFromBooks(_ value: BookCSVData)
